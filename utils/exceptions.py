...
class AnalysisError(NiklausError):
    ...
    def __init__(self, message: str, file1: str = None, file2: str = None):
        self.file1 = file1
        self.file2 = file2
        super().__init__(message)
...
class CacheError(NiklausError):
    ...
    def __init__(self, message: str, cache_file: str = None):
...
class ParallelProcessingError(NiklausError):
    ...
    def __init__(self, message: str, task_id: int = None, original_error: Exception = None):
